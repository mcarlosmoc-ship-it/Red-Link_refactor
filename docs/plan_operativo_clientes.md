...
- La descarga de plantilla ahora usa `GET /clients/import/template`, incluye presets (básico, avanzado y solo servicios) y documenta columnas `service_1_*`/`service_2_*` para cargar varios servicios por cliente en una sola fila. 【F:src/components/clients/ImportClientsModal.jsx†L48-L202】【F:docs/client_import_status.md†L1-L22】
