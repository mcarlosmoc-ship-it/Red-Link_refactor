...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("reseller_income", sa.Numeric(14, 2), nullable=False, server_default="0"),
        sa.Column("net_earnings", sa.Numeric(14, 2), nullable=False, server_default="0"),
        sa.Column("clients_active", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("clients_delinquent", sa.Integer(), nullable=False, server_default="0"),
    )
